...
document_version: 2026-07-05
canonical_url: https://raw.githubusercontent.com/ParagEkbote/ParagEkbote.github.io/main/contributions.md
---
...
**Combined repository stars:** 482,436 ⭐
...
- `huggingface/transformers` → 6 PRs, ⭐ 162,258
- `pytorch/pytorch` → 2 PRs, ⭐ 101,503
- `hiyouga/LlamaFactory` → 1 PR, ⭐ 72,960
- `huggingface/diffusers` → 19 PRs, ⭐ 33,984
- `huggingface/trl` → 2 PRs, ⭐ 18,768
- `dagster-io/dagster` → 1 PR, ⭐ 15,786
- `optuna/optuna` → 7 PRs, ⭐ 14,449
- `Lightning-AI/litgpt` → 1 PR, ⭐ 13,463
- `linkedin/Liger-Kernel` → 11 PRs, ⭐ 6,481
- `skorch-dev/skorch` → 6 PRs, ⭐ 6,168

![Open Source Contributions](assets/oss_hero_image.jpeg)
...
- `huggingface/transformers` → ⭐ 162,258, forks 33,765, open issues 2,484
- `pytorch/pytorch` → ⭐ 101,503, forks 28,260, open issues 18,256
- `hiyouga/LlamaFactory` → ⭐ 72,960, forks 8,918, open issues 1,061
- `huggingface/diffusers` → ⭐ 33,984, forks 7,119, open issues 1,246
- `huggingface/trl` → ⭐ 18,768, forks 2,822, open issues 406
- `dagster-io/dagster` → ⭐ 15,786, forks 2,183, open issues 2,571
- `optuna/optuna` → ⭐ 14,449, forks 1,349, open issues 23
- `Lightning-AI/litgpt` → ⭐ 13,463, forks 1,467, open issues 264
- `linkedin/Liger-Kernel` → ⭐ 6,481, forks 553, open issues 156
- `skorch-dev/skorch` → ⭐ 6,168, forks 408, open issues 64
- `zenml-io/zenml` → ⭐ 5,470, forks 632, open issues 128
- `mlabonne/llm-datasets` → ⭐ 4,681, forks 389, open issues 10
- `huggingface/notebooks` → ⭐ 4,586, forks 1,823, open issues 225
- `huggingface/blog` → ⭐ 3,454, forks 1,026, open issues 249
- `argilla-io/distilabel` → ⭐ 3,311, forks 247, open issues 99
- `alibaba/ROLL` → ⭐ 3,282, forks 293, open issues 119
- `huggingface/cookbook` → ⭐ 2,691, forks 411, open issues 60
- `huggingface/lighteval` → ⭐ 2,467, forks 501, open issues 338
- `gradio-app/trackio` → ⭐ 1,564, forks 123, open issues 9
- `PrunaAI/pruna` → ⭐ 1,244, forks 94, open issues 28
