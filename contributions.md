...
**Combined repository stars:** 482,613 ⭐
...
- `huggingface/transformers` → 6 PRs, ⭐ 162,303
- `pytorch/pytorch` → 2 PRs, ⭐ 101,535
- `hiyouga/LlamaFactory` → 1 PR, ⭐ 73,007
- `huggingface/diffusers` → 19 PRs, ⭐ 33,992
- `huggingface/trl` → 2 PRs, ⭐ 18,780
- `dagster-io/dagster` → 1 PR, ⭐ 15,793
- `optuna/optuna` → 7 PRs, ⭐ 14,455
- `Lightning-AI/litgpt` → 1 PR, ⭐ 13,467
- `linkedin/Liger-Kernel` → 11 PRs, ⭐ 6,484
...
- `pytorch/pytorch` → ⭐ 101,535, forks 28,271, open issues 18,243
- `hiyouga/LlamaFactory` → ⭐ 73,007, forks 8,924, open issues 1,066
- `huggingface/diffusers` → ⭐ 33,992, forks 7,122, open issues 1,249
- `huggingface/trl` → ⭐ 18,780, forks 2,827, open issues 407
- `dagster-io/dagster` → ⭐ 15,793, forks 2,185, open issues 2,569
- `optuna/optuna` → ⭐ 14,455, forks 1,348, open issues 25
...
- `zenml-io/zenml` → ⭐ 5,471, forks 632, open issues 126
...
- `PrunaAI/pruna` → ⭐ 1,245, forks 94, open issues 29
