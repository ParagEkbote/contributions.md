...
**Combined repository stars:** 482,612 ⭐
...
- `hiyouga/LlamaFactory` → 1 PR, ⭐ 73,006
...
- `pytorch/pytorch` → ⭐ 101,535, forks 28,271, open issues 18,242
- `hiyouga/LlamaFactory` → ⭐ 73,006, forks 8,924, open issues 1,066
- `huggingface/diffusers` → ⭐ 33,992, forks 7,122, open issues 1,249
- `huggingface/trl` → ⭐ 18,780, forks 2,827, open issues 409
